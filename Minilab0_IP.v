...
reg [1:0]wren_pass, wren_pass_hold;
...
reg [DATA_WIDTH*3-1:0] macout_reg;
wire [DATA_WIDTH*3-1:0] adder_result;	
// store macout
always @(posedge CLOCK_50, negedge rst_n) begin
    if (!rst_n)
        macout_reg <= 0; // Reset accumulator
	else if (state == DONE)
		macout_reg <= macout_reg;	
    else
        macout_reg <= (adder_result === 24'hzzzzzz) ? 0 : adder_result; 
end

Accum_add_sub iadder(
    .dataa(macout_reg),
    .datab(mult_result),
    .result(adder_result)
	);
assign macout = macout_reg;
//=======================================================
//  Structural coding
//=======================================================
...
// double flopping wren and datain signal
